...
algo['short_m_avg'] = algo['price'].rolling(window = short_period, min_periods = short_period).mean()
algo['long_m_avg'] = algo['price'].rolling(window = long_period, min_periods = long_period).mean()
